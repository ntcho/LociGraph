  ...
  "relative w-full rounded-lg border border-stone-200 p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-stone-950 dark:border-stone-800 dark:[&>svg]:text-stone-50",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-orange-500/50 text-orange-500 dark:border-orange-500 [&>svg]:text-orange-500 dark:border-orange-500/50 dark:text-orange-600 dark:dark:border-orange-600 dark:[&>svg]:text-orange-600"
      }
    },
    defaultVariants: {
      variant: "default"
